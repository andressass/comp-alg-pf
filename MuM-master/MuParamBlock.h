 ...
 *
 * @details The MuParamBlock class is used to wrap a vector of floating point values, so that these 
...
class MuParamBlock
{
	...
	**/		
	 ...
	 *
	 * @details Trunc() eliminates the upper n elements of an MuParamBlock object’s internal array. If n 
